...
- `payment`, provider payment gas units, currently the SDK constant `100000`.
...
payment gas units. Later versions can optimize it into a smaller payload id, checksum,
